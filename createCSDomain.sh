...
aws cloudsearch define-index-field --domain-name $DOMAIN --name content --type text --sort-enabled false --return-enabled false
aws cloudsearch define-index-field --domain-name $DOMAIN --name description --type text --sort-enabled false
aws cloudsearch define-index-field --domain-name $DOMAIN --name keywords --type text-array --return-enabled false --highlight-enabled false
